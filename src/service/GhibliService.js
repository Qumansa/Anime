...
const useGhibliService = () => {
    ...
    const getCharacters = () => {
        return Promise.all([
            request(`${_apiBase}people/267649ac-fb1b-11eb-9a03-0242ac130003`),
            request(`${_apiBase}people/598f7048-74ff-41e0-92ef-87dc1ad980a9`),
            request(`${_apiBase}people/ebe40383-aad2-4208-90ab-698f00c581ab`),
            request(`${_apiBase}people/7151abc6-1a9e-4e6a-9711-ddb50ea572ec`),
            request(`${_apiBase}people/d39deecb-2bd0-4770-8b45-485f26e1381f`),
            request(`${_apiBase}people/8228751c-bdc1-4b8d-a6eb-ca0eb909568f`)
        ]);
    };
